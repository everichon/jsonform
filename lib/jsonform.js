...
jsonform.fieldTemplate = function(inner) {
  return '<div class="form-group jsonform-error-<%= keydash %>' +
    ...
    '<% if (node.title && !elt.notitle) { %>' +
      '<label class="control-label <%= (fieldLabelHtmlClass ? fieldLabelHtmlClass : "") %>" for="<%= node.id %>"><%= node.title %></label>' +
    '<% } %>' +
    '<div <%= (fieldContainerHtmlClass ? " class=\'" + fieldContainerHtmlClass + "\'" : "") %> >' +
...
jsonform.elementTypes = {
  ...
  'array': {
    'template': '<div id="<%= id %>"><ul class="_jsonform-array-ul" style="list-style-type:none;"><%= children %></ul>' +
      '<span class="_jsonform-array-buttons">' +
        '<a href="#" class="btn _jsonform-array-addmore"><i class="fa fa-plus" title="Add new"></i></a> ' +
        '<a href="#" class="btn _jsonform-array-deletelast"><i class="fa fa-minus" title="Delete last"></i></a>' +
      '</span>' +
      '</div>',
    'fieldtemplate': true,
    'array': true,
    'childTemplate': function (inner) {
      if ($('').sortable) {
        ...
        return '<li data-idx="<%= node.childPos %>">' +
          '<span class="draggable line"><i class="fa fa-list-ol" title="Move item"></i></span>' +
          inner +
          '</li>';
      }
      else {
  ...
  'tabarray': {
    'template': '<div id="<%= id %>"><div class="tabbable tabs-left">' +
      ...
      '</div>' +
      '<a href="#" class="btn _jsonform-array-addmore"><i class="fa fa-plus" title="Add new"></i></a> ' +
      '<a href="#" class="btn _jsonform-array-deleteitem"><i class="fa fa-minus" title="Delete item"></i></a></div>',
    'fieldtemplate': true,
    'array': true,
    'childTemplate': function (inner) {
  ...
  'fieldset':{
    'template': '<fieldset class="jsonform-error-<%= keydash %> <% if (elt.expandable) { %>expandable<% } %> <%= elt.htmlClass?elt.htmlClass:"" %>" ' +
      '<% if (id) { %> id="<%= id %>"<% } %>' +
      '>' +
...
formNode.prototype.generate = function () {
  ...
  data.fieldLabelHtmlClass = '';
  data.fieldContainerHtmlClass = '';
  data.fieldHtmlClass = '';

  if (this.ownerTree &&
      this.ownerTree.formDesc &&
      this.ownerTree.formDesc.params) {
    var params = this.ownerTree.formDesc.params;
    data.fieldLabelHtmlClass = params.fieldLabelHtmlClass ? params.fieldLabelHtmlClass : '';
    data.fieldContainerHtmlClass = params.fieldContainerHtmlClass ? params.fieldContainerHtmlClass : '';
    data.fieldHtmlClass = params.fieldHtmlClass ? params.fieldHtmlClass : '';
  }
  if (this.formElement &&
